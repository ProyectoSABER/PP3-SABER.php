...
-- Tiempo de generación: 23-08-2022 a las 01:45:35
...
CREATE TABLE IF NOT EXISTS `autor` (
  ...
  `nomb_Autor` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `barrio` (
  ...
  `nom_barrio` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `categorialibro` (
  ...
  `categoria_cateLibro` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `categoriasocio` (
  ...
  `nom_CategoriaSocio` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `categoria_provee` (
  ...
  `tipo_provee` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cobrocuota` (
  ...
  `CobroCuotacol` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `detallecobro` (
  ...
  `estadoCobroCuota` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `domicilio` (
  ...
  `nom_calle` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `editorial` (
  ...
  `nom_editorial` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
ALTER TABLE `detallecuota`
  ADD CONSTRAINT `idCuota_DetCuota` FOREIGN KEY (`id_Cuota`) REFERENCES `cuota` (`id_MesAnio_Cuota`),
  ADD CONSTRAINT `idSocio_DetCuota` FOREIGN KEY (`id_Socio`) REFERENCES `socio` (`id_socio`);
