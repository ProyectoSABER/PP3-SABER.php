...
require_once './Handler/cobro/HandlerListadoCobros.php'
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="">
                      ...
                      <td scope="row"><?php echo convertir_fechaMesAnio($res[$i]["detalleCobro"]["MESANIOCUOTA"]) ?></td>
                      ...
                      <td><?php echo convertir_fecha($res[$i]["detalleCobro"]["FECHACOBROCUOTA"]) ?></td>
                      <td><?php echo $res[0]["detalleBibliotecario"]["NOMBRE"] . ' ' . $res[0]["detalleBibliotecario"]["APELLIDO"] ?></td>
                      ...
                      <td><a class="btn btn-outline-light" role="button" onClick="imprimirComprobante(<?php echo $res[$i]["detalleCobro"]["IDDETALLECOBRO"] ?>)"><i class="fas fa-file-pdf"></i></a></td>
                    </tr>
                  <?php
                    $total += $subtotal;
                  } ?>
