...
<tr>
           ...
           <td>
           <button type="button" onclick="registrarPrestamo('<?php  echo $libro['Libro_ISBN'] ?>')" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
...
function registrarPrestamo(idISBN){
