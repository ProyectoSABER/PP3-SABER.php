...
<tr>
           ...
           <td><?php echo "<a href=Handler/Prestamos/HandlerRegistrarPrestamoLibro.php?RegistrarPrestamoUsuario=1&ID_ISBN=".$libro['Libro_ISBN']."&ID_TIPO=".$libro['Libro_Titulo']."&ID_USER=".$libro['Libro_Titulo'].">
          SOLICITAR LIBRO</a>";?><button type="button" onclick="registrarprestramo(<?php echo 2; ?>)" value="solicitar" class="btn btn-primary">
...
function registrarprestamo(idejemplar){
