...
function imprimirComprobanteDevolucion(data){
 
 
  $.post("page/Comprobantes/comprobanteDevolucionLibro.php",{"idDetallePrestamo":data}, function(result){
  newWind=window.open('page/Comprobantes/comprobanteDevolucionLibro.php','nuevaVentana');
