...
require_once './Handler/prestamos/HandlerHistorialdePrestamosLibros.php'
...
<body class="app sidebar-mini pace-done sidenav-toggled">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-th-list"></i> Historial</h1>

        <p id="title">Historial de Prestamos de Libros</p>

      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Historial</li>
        <li class="breadcrumb-item active"><a href="#">Historial de Prestamo</a></li>
      </ul>
    </div>
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Total de Prestamos en historial: <?php echo $CantPrestamos ?> </h3>
              ...
              <tbody>
                <?php for ($i = 0; $i < $CantPrestamos; $i++) { ?>
                  ...
                  <tr class=<?php echo ($i % 2 == 0) ?  'table-info' : ''; ?>>
                    ...
                    <a class="btn btn-sm btn-outline-info" role="button" onclick="imprimirComprobanteDevolucion(<?php echo $Prestamos[$i]['ID'] ?>)"><i class="fas fa-file-pdf" aria-hidden="true"></i></a>&nbsp;&nbsp;</td>
                  </tr>
                <?php } ?>
  ...
  $Export="./js/Personalizados/ExportarPDF/pdfExport_comprobantePrestamo.js";
  require_once('./Inc/js/jsTableToExport.inc.php'); ?>
